...
public class A04_PreparedDao {
    ...
    public List<Employee> getEmpList(Map<String, String> sch) {
        ...
        try {
            ...
            System.out.println("DB_Prj 관련 오류: " + e.getMessage());
        } catch (Exception e) {
            System.out.println("일반 오류: " + e.getMessage());
        } finally {
            DB_Prj.close(rs, pstmt, con);
        }
        return elist;
    }
    ...
    public List<JobHistory> getHistory(Map<String, String> sch) {
        ...
        try {
            ...
            System.out.println("DB_Prj 예외: " + e.getMessage());
        } catch (Exception e) {
    ...
    public void insertEmp(Emp ins) {
        ...
        try {
            ...
            System.out.println("DB_Prj 오류: " + e.getMessage());
            DB_Prj.rollback(con);
        } catch (Exception e) {
            System.out.println("일반 오류: " + e.getMessage());
        } finally {
