    ...
    <div class="container mt-3">
       ...
       <form method="post">
        ...
        <div class="mb-3">
          ...
          <input type="text" value="${emp.mgr}" class="form-control" id="mgr" placeholder="Enter mgr" name="mgr">
        </div>
        <div class="mb-3">
          <label for="hiredateS" class="form-label">hiredate:</label>
          <input type="date" value="${emp.hiredate}" class="form-control" id="hiredateS" placeholder="Enter hiredate" name="hiredateS">
        </div>
        <div class="mb-3">
        ...
        <button id="uptBtn" type="button" class="btn btn-warnnig">수정</button>
        <button id="delBtn" type="button" class="btn btn-danger">삭제</button>
        <button type="button" id="goMain" class="btn btn-primary">메인화면</button>
      </form>    
      <script>
