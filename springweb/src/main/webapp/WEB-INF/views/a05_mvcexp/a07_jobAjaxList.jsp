			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="regFrm"  class="form" method="post">
						<div class="row">
							<div class="col">
								<input type="text" class="form-control" placeholder="직책 아이디 입력"
									name="job_id">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col">
								<input type="number" class="form-control" placeholder="최소급여 입력"
									name="min_salary">
							</div>						
						</div>
						<div class="row">
							<div class="col">
								<input type="number" class="form-control" placeholder="최대급여 입력"
									name="max_salary">
							</div>						
						</div>
					</form>
				...
				<div class="modal-footer">
					...
					<button type="button" id="jobRegBtn" class="btn btn-success">직책 등록</button>
				</div>
			</div>
		</div>
	</div>
